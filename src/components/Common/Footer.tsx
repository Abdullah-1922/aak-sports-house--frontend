    ...
    <div className="flex py-5 m-auto text-white text-sm flex-col items-center border-t max-w-screen-xl">
      <div className="md:flex-auto md:flex-row-reverse mt-2 flex-row flex">
        <a href="#" className="w-6 mx-1">
          <svg className="fill-current cursor-pointer text-gray-500 hover:text-indigo-600" width="100%" height="100%" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" xmlSpace="preserve" style={{ fillRule: "evenodd", clipRule: "evenodd", strokeLinejoin: "round", strokeMiterlimit: 2 }}>
        ...
        <a href="#" className="w-6 mx-1">
          <svg className="fill-current cursor-pointer text-gray-500 hover:text-indigo-600" width="100%" height="100%" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" xmlSpace="preserve"  style={{ fillRule: "evenodd", clipRule: "evenodd", strokeLinejoin: "round", strokeMiterlimit: 2 }}>
            <g id="Layer_1">
              ...
              <path id="Shape" d="M19.05,8.362c0,-0.062 0,-0.125-0.063,-0.187l0,-0.063c-0.187,-0.562-0.687,-0.937-1.312,-0.937l0.125,0c0,0-2.438,-0.375-5.75,-0.375c-3.25,0-5.75,0.375-5.75,0.375l0.125,0c-0.625,0-1.125,0.375-1.313,0.937l0,0.063c0,0.062 0,0.125-0.062,0.187c-0.063,0.625-0.25,1.938-0.25,3.438c0,1.5 0.187,2.812 0.25,3.437c0,0.063 0,0.125 0.062,0.188l0,0.062c0.188,0.563 0.688,0.938 1.313,0.938l-0.125,0c0,0 2.437,0.375 5.75,0.375c3.25,0 5.75,-0.375 5.75,-0.375l-0.125,0c0.625,0 1.125,-0.375 1.312,-0.938l0,-0.062c0.063,-0.063 0.063,-0.125 0.063,-0.188c0.063,-0.625 0.25,-1.938 0.25,-3.437c0,-1.5-0.187,-2.813-0.25,-3.438Zm-9.313,5.813l0,-5.625l4.875,2.813l-4.875,2.812Z" fill="#ffffff"></path>
            </g>
          </svg>
        </a>
        <a href="#" className="w-6 mx-1">
          <svg className="fill-current cursor-pointer text-gray-500 hover:text-indigo-600" width="100%" height="100%" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" xmlSpace="preserve"  style={{ fillRule: "evenodd", clipRule: "evenodd", strokeLinejoin: "round", strokeMiterlimit: 2 }}>
            <path id="LinkedIn" d="M24,12c0,6.627-5.373,12-12,12c-6.627,0-12-5.373-12-12c0-6.627 5.373-12 12-12c6.627,0 12,5.373 12,12Zm-16.154,6.3l0,-9.62l-2.916,0l0,9.62l2.916,0Zm-1.482,-10.938c0.993,0 1.627,-0.655 1.627,-1.475c-0.018,-0.838-0.634-1.475-1.61-1.475c-0.978,0-1.626,0.637-1.626,1.475c0,0.82 0.634,1.475 1.593,1.475h0.016Zm3.648,10.938l2.917,0l0,-5.387c0,-0.29 0.021,-0.578 0.106,-0.785c0.232,-0.578 0.759,-1.177 1.644,-1.177c1.159,0 1.621,0.888 1.621,2.188l0,5.16l2.917,0l0,-5.537c0,-2.973-1.585,-4.356-3.698,-4.356c-1.739,0-2.519,0.967-2.953,1.639l-0.127,0.217l-0.017,-0.017l0,-1.404l-2.916,0c0.037,0.904 0,9.62 0,9.62Z"></path>
          </svg>
        </a>
      </div>
